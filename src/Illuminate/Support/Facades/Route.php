 ...
 * @method static \Illuminate\Routing\Router concurrentMiddleware(string $name, array<int, string> $middleware)
 * @method static array<int, string> getConcurrentMiddleware(string $name)
 * @method static bool hasConcurrentMiddleware(string $name)
