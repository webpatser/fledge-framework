 ...
 * @method static \GuzzleHttp\Psr7\Response psr7Response(array|string|null $body = null, int $status = 200, array<string, mixed> $headers = [])
 ...
 * @method static \Illuminate\Support\Collection<int, array> recorded(\Closure|callable $callback = null)
