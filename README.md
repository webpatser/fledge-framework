...
**121 files changed** on top of Laravel 13.12.0. The full framework test suite passes, apart from a few upstream dependency-drift failures (symfony 8.1, Predis) that also affect vanilla Laravel 13 on PHP 8.5.
...
All standard Composer constraint patterns resolve to the latest Fledge tag (`v13.12.0.1` as of 2026-05-30):

| Constraint | Resolves to | Notes |
|------------|------------|-------|
| `^13.3` | v13.12.0.1 | Recommended, accepts any 13.x release |
| `^13.12` | v13.12.0.1 | Pins to current minor |
| `~13.12.0` | v13.12.0.1 | Pins to 13.12.x patches and Fledge revisions |
| `13.12.*` | v13.12.0.1 | Wildcard, identical resolution |
| `^13.12.0.1` | v13.12.0.1 | Pin to a specific Fledge revision |
| `~13.12.0.1` | v13.12.0.1 | Same, accepts higher Fledge patches |
| `>=13.0` | v13.12.0.1 | Open-ended |
...
- Full framework test suite passing, save for a few upstream dependency-drift failures (symfony 8.1 header-bag deprecation, Predis) that also occur on vanilla Laravel 13 + PHP 8.5
