...
|------------|------------|-------|
| `^13.3` | v13.17.0.2 | Recommended, accepts any 13.x release |
| `^13.17` | v13.17.0.2 | Pins to current minor |
| `~13.17.0` | v13.17.0.2 | Pins to 13.17.x patches and Fledge revisions |
| `13.17.*` | v13.17.0.2 | Wildcard, identical resolution |
| `^13.17.0.1` | v13.17.0.2 | Pin to a specific Fledge revision |
| `~13.17.0.1` | v13.17.0.2 | Same, accepts higher Fledge patches |
| `>=13.0` | v13.17.0.2 | Open-ended |
