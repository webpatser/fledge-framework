...
**121 files changed** on top of Laravel 13.12.0. The full framework test suite passes under CI's `--fail-on-deprecation`, including against symfony 8.1.
...
All standard Composer constraint patterns resolve to the latest Fledge tag (`v13.12.0.2` as of 2026-05-30):

| Constraint | Resolves to | Notes |
|------------|------------|-------|
| `^13.3` | v13.12.0.2 | Recommended, accepts any 13.x release |
| `^13.12` | v13.12.0.2 | Pins to current minor |
| `~13.12.0` | v13.12.0.2 | Pins to 13.12.x patches and Fledge revisions |
| `13.12.*` | v13.12.0.2 | Wildcard, identical resolution |
| `^13.12.0.1` | v13.12.0.2 | Pin to a specific Fledge revision |
| `~13.12.0.1` | v13.12.0.2 | Same, accepts higher Fledge patches |
| `>=13.0` | v13.12.0.2 | Open-ended |
